    ...
    def can_preview(self, data_dict):
        ...
        if format_lower in self.NGSI_FORMATS:
            if resource['on_same_domain'] or self.proxy_is_enabled:
                if self.check_query(resource) and oauth_req == 'true' and not p.toolkit.c.user:
                ...
                elif self.check_query(resource) and oauth_req == 'true' and not self.oauth2_is_enabled:
